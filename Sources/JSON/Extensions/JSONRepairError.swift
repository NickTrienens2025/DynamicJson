...
class JSONCommentRemover {
    ...
    static func removeComments(from jsonString: String) -> String {
...
func repairJSONString(_ jsonString: String) throws -> String {
      var stack = [String]()
...
enum JSONRepairError: Error {
    case invalidJSONString
}
enum JSONContext: Equatable {
...
func repairJSON(_ str: String, debugging : Bool = false) throws -> String {
